...
/* LCM fingerprint hash — matches C++ Char::getHash() */
static inline int64_t dimos_msg__Char__fingerprint(void) {
...
static const dimos_lcm_type_t dimos_msg__Char__type = {
    /* name */          "std_msgs.Char",
    /* fingerprint */   (int64_t)-1654270087181739132LL,
    /* encoded_size */  1,
    /* decode */        (int (*)(const void *, int, int, void *))dimos_msg__Char__decode
};
#endif
