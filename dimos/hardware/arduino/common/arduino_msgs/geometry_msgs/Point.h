...
/* LCM fingerprint hash — matches C++ Point::getHash() */
static inline int64_t dimos_msg__Point__fingerprint(void) {
...
static const dimos_lcm_type_t dimos_msg__Point__type = {
    /* name */          "geometry_msgs.Point",
    /* fingerprint */   (int64_t)-5873151609983426274LL,
    /* encoded_size */  24,
    /* decode */        (int (*)(const void *, int, int, void *))dimos_msg__Point__decode
};
#endif
