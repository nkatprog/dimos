...
/* LCM fingerprint hash — matches C++ Point32::getHash() */
static inline int64_t dimos_msg__Point32__fingerprint(void) {
    return (int64_t)6064627023998310424LL;
}

/* Type descriptor for dimos_lcm_pubsub — include dimos_lcm_pubsub.h first */
#ifdef DIMOS_LCM_PUBSUB_H
static const dimos_lcm_type_t dimos_msg__Point32__type = {
    /* name */          "geometry_msgs.Point32",
    /* fingerprint */   (int64_t)6064627023998310424LL,
    /* encoded_size */  12,
    /* decode */        (int (*)(const void *, int, int, void *))dimos_msg__Point32__decode
};
#endif
