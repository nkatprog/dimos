...
/* LCM fingerprint hash — matches C++ Accel::getHash() */
static inline int64_t dimos_msg__Accel__fingerprint(void) {
...
static const dimos_lcm_type_t dimos_msg__Accel__type = {
    /* name */          "geometry_msgs.Accel",
    /* fingerprint */   (int64_t)3349560846311743527LL,
    /* encoded_size */  48,
    /* decode */        (int (*)(const void *, int, int, void *))dimos_msg__Accel__decode
};
#endif
