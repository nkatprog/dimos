...
class JointState(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.name_length):
            ...
            buf.write(b"\0")
        buf.write(
            struct.pack(">%dd" % self.position_length, *self.position[: self.position_length])
        )
        buf.write(
            struct.pack(">%dd" % self.velocity_length, *self.velocity[: self.velocity_length])
        )
    ...
    def _decode_one(cls, buf):
        self = JointState()
        self.name_length, self.position_length, self.velocity_length, self.effort_length = (
